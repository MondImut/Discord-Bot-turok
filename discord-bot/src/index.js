 ...
 *
 * BoomBox v1.5.0 (Turok) is initialised inside the 'clientReady' handler
 * after the guild cache is populated.
 */
...
import { shutdownBoomBox }         from './features/boombox/index.js';
...
function startBot(secrets) {
  ...
  // Shared mutable state: commands map populated in clientReady, read in interactionCreate.
